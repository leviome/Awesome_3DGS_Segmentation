...
`ICCV 2025` | [`Paper`](https://arxiv.org/abs/2508.03227) | [`Project`](https://trace-3d.github.io/)

* **LangSplatV2: High-dimensional 3D Language Gaussian Splatting with 450+ FPS** <br>
`NIPS 2025` | [`Paper`](https://arxiv.org/abs/2507.07136) | [`Project`](https://langsplat-v2.github.io/)
...
* **Tackling View-Dependent Semantics in 3D Language Gaussian Splatting** <br>
`ICML 2025` | [`Paper`](https://openreview.net/forum?id=oaMDLJezM4) | [`Project`](https://github.com/SJTU-DeepVisionLab/LaGa)
...
* **iSegMan: Interactive Segment-and-Manipulate 3D Gaussians** <br>
`CVPR 2025` | [`Paper`](https://arxiv.org/abs/2505.11934) | [`Project`](https://zhao-yian.github.io/iSegMan)
...
`ICML 2025` | [`Paper`](https://arxiv.org/abs/2508.08252) | [`Project`](https://github.com/heshuting555/ReferSplat)

* **Segment then Splat: A Unified Approach for 3D Open-Vocabulary Segmentation based on Gaussian Splatting** <br>
`NIPS 2025` | [`Paper`](https://arxiv.org/abs/2503.22204) | [`Project`](https://vulab-ai.github.io/Segment-then-Splat/)
...
* **Online Segment Any 3D Thing as Instance Tracking.** <br>
`NeurIPS 2025` | [`Paper`](https://arxiv.org/abs/2512.07599) | [`Project`](https://github.com/AutoLab-SAI-SJTU/AutoSeg3D)
...
* **SegDINO3D: 3D Instance Segmentation Empowered by Both Image-Level and Object-Level 2D Features** <br>
`Arxiv` | [`Paper`](https://arxiv.org/abs/2509.16098) | [`Project`](https://github.com/IDEA-Research/SegDINO3D)
